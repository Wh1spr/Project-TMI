...
Indien we het Kgem bepalen (uitgemiddeld over i = 1,...,N) zullen we een goede schatting hebben hoeveel punten er worden vergeleken in iedere iteratie van de doorlooplijn.
We rekenen bij Kgem ook het eerste element bij die een K zal hebben van 0, dus kunnen we bij onze doorloplijn iteratie het eerste punt ook meetellen.
...
Voor Kavg kunnen we concluderen dat per N het aantal kavg voor de worst-case gelijk zal zijn aan N-1/2.
...
De rekencomplexiteit is gelijk aan (N*Kavg), hieruit kunnen we zien dat voor een stijgende rekencomplexiteit we ook een stijgende Kavg nodig zullen hebben.
...
Hieruit kunnen we concluderen dat voor een groot aantal punten de Kmax ook zal evalueren
